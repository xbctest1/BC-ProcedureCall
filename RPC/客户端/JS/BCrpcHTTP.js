function BCrpcHTTP(host, timeout) {
	this.host = 'http://' + host;
	this.timeout = (timeout || 60) * 1000;
}

BCrpcHTTP.prototype.call = function (msg, param, retnfunc) {
	...
	xhr.onload = function () {
		...
		retnfunc && retnfunc(unpack('l', res), res.slice(8, 8 + len));
	}
	xhr.onerror = xhr.ontimeout = function () {
		retnfunc && retnfunc(-1024, null);
	}
